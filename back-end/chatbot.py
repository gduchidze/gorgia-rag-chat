...
def rewrite_query(llm, user_input: str, chat_history: list = None) -> str:
    ...
    3. დატოვე მხოლოდ არსებითი საძიებო ტერმინები და გამოიყენე მხოლოდ არსებითი სახელები და მთავარი საკვანძო სიტყვები
...
def create_gorgia_agent():
    ...
    თქვენ ხართ Gorgia-ს სპეციალიზირებული ასისტენტი. თქვენი კომპეტენცია მკაცრად შემოიფარგლება:გორგიას პროდუქტების კატალოგით, გორგიას სერვისებით და მომსახურებით, კომპანიის პოლიტიკით და პროცედურებით და ა.შ.
    ...
    5. არ უპასუხო არალოგიკურ შეკთხვებს
    
    როცა შეკითხვა სცდება თქვენს კომპეტენციას, უპასუხეთ: "ბოდიში, მე ვარ კომპანია გორგიას ასისტენტი და შემიძლია დაგეხმაროთ მხოლოდ გორგიას პროდუქტებთან ან სერვისებთან დაკავშირებით. გთხოვთ დასვათ შეკითხვა ამ თემებზე."
